...
class PackageReleaseTest(unittest.TestCase):
    ...
    def test_archive_is_reproducible_and_exact(self):
        ...
        with gzip.open(first, "rb") as stream:
            ...
            self.assertIn(b"deterministic Stack executable fixture", contents)
            self.assertIn(b"Generated by `stack completions bash`", contents)
            self.assertIn(b"Stack CLI Manual", contents)
